...
public class TcpClient {
    ...
    public boolean connect() {
        ...
        try {
            ...
            Logger.error(this.getName() + "连接失败：" + e.getMessage());
            Logger.debug(e);
        }
        return false;
    }
    ...
    public int read(byte[] buffer) {
        ...
        try {
            ...
            this.aborted = true;
            Logger.error(this.getName() + "接收数据失败：" + e.getMessage());
            Logger.debug(e);
        }
        return 0;
    }
    ...
    public int write(byte[] buffer) {
        ...
        try {
            ...
            this.aborted = true;
            Logger.error(this.getName() + "发送数据失败：" + e.getMessage());
            Logger.debug(e);
            return 0;
        }
    ...
    public void disConnect() {
        try {
            ...
            this.aborted = true;
            Logger.error(this.getName() + "关闭失败：" + e.getMessage());
            Logger.debug(e);
        }
    }
}
